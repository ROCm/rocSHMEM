...
**Description:**
Block the caller until the condition (*ivars cmps val) is true.
...
**Description:**
Block the caller until the condition (ivars[i] cmps val) is true for all ivars
...
**Description:**
Block the caller until any of the condition (ivars[i] cmps val) is true.
...
**Description:**
Block the caller until any of the conditions (ivars[i] cmps val) is true.
...
.. cpp:function:: __device__ int rocshmem_TYPENAME_test(TYPE *ivars, int cmp, TYPE val)
  ...
  :returnS:     1 if the evaluation is true else 0.

**Description:**
Test if the condition (*ivars cmps val) is true.
